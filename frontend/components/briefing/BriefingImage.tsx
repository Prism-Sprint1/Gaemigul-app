...
export default function BriefingImage({ url, alt }: BriefingImageProps) {
  if (!url) {
    return (
      <div
        role="img"
        aria-label={alt}
        className="flex aspect-1200/400 w-full flex-col items-center justify-center gap-2 rounded-lg bg-neutral-200 text-neutral-400"
      >
        <ImageOff size={28} />
  ...
  return (
    ...
    <img
      src={url}
      alt={alt}
      className="aspect-1200/400 w-full rounded-lg bg-neutral-100 object-cover"
    />
  )
}
