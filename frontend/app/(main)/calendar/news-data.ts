...
export const NEWS: NewsItem[] = [
  ...
  { id: 'n8', title: '엔비디아 2분기 실적 발표', summary: 'AI 가속기 수요와 데이터센터 매출 가이던스가 관전 포인트.', category: 'earnings', region: '엔비디아', publishedAt: new Date('2026-08-27T06:00:00'), highlight: 'special', detail: { forecast: 'EPS 1.24달러', previous: 'EPS 0.68달러', source: 'NVIDIA IR', sectors: ['반도체', 'HBM', 'AI 인프라'] } }, // prettier-ignore
  ...
  { id: 'n14', title: '연준 베이지북 공개', summary: '12개 지역 연은의 체감 경기 보고. FOMC 전 정성적 판단 근거.', category: 'rate', region: '미국', publishedAt: new Date('2026-09-03T03:00:00') }, // prettier-ignore
  ...
  { id: 'n2', title: 'ECB 통화정책회의 사전 브리핑', summary: '라가르드 총재 연설 전 물가 코멘트 점검.', category: 'rate', region: '유로존', publishedAt: new Date('2026-09-07T17:00:00')}, // prettier-ignore
  ...
  { id: 'n6', title: '아이폰 및 신규 3nm 인공지능 프로세서 공개', summary: '국내 반도체/디스플레이 밸류체인 수혜 점검.', category: 'earnings', region: '애플', publishedAt: new Date('2026-09-09T02:00:00') }, // prettier-ignore
  ...
  { id: 'n18b', title: '오라클 실적발표', summary: '클라우드 인프라(OCI) 수주 잔고와 AI向 데이터센터 투자 계획이 관전 포인트.', category: 'earnings', region: '오라클', publishedAt: new Date('2026-09-11T06:00:00'), highlight: 'special', replay: true, detail: { forecast: 'EPS 1.48달러', previous: 'EPS 1.39달러', source: 'Oracle IR', sectors: ['클라우드', 'AI 인프라'] } }, // prettier-ignore
  { id: 'n19', title: 'ECB 기준금리 결정', summary: '예금금리 동결 유력. 라가르드 회견에서 추가 인하 시점 힌트 주목.', category: 'rate', region: '유로존', publishedAt: new Date('2026-09-11T21:15:00'), detail: { forecast: '동결(예금 2.00%)', previous: '2.00%', source: 'ECB' } }, // prettier-ignore
  { id: 'n20', title: '9월 선물·옵션 동시만기일(쿼드러플위칭)', summary: '분기 마지막 동시만기. 프로그램 매물·베이시스 청산으로 장중 변동성 확대.', category: 'optionExpiry', region: '한국', publishedAt: new Date('2026-09-11T15:20:00') }, // prettier-ignore
  ...
  { id: 'n24', title: 'FOMC 기준금리 결정', summary: '25bp 인하 여부와 점도표(연내 추가 인하 횟수)가 핵심. 시장 컨센서스는 인하.', category: 'rate', region: '미국', publishedAt: new Date('2026-09-17T03:00:00'), detail: { forecast: '25bp 인하', previous: '동결', source: '미국 연준(FOMC)', sectors: ['성장주', '리츠', '중소형주', '금'] } }, // prettier-ignore
  { id: 'n25', title: '파월 의장 기자회견', summary: '성명서 문구 변화와 함께 향후 인하 경로에 대한 톤이 자산시장 방향 결정.', category: 'rate', region: '미국', publishedAt: new Date('2026-09-17T03:30:00') }, // prettier-ignore
  { id: 'n26', title: '일본은행(BOJ) 금융정책결정회의', summary: '추가 금리 인상 시점 관련 코멘트. 엔화·닛케이·수출주에 영향.', category: 'rate', region: '일본', publishedAt: new Date('2026-09-19T08:00:00'), detail: { forecast: '동결', previous: '동결', source: 'BOJ' } }, // prettier-ignore
  ...
  { id: 'n38', title: 'FOMC 의사록 공개(9월 회의)', summary: '점도표 뒤 위원별 견해차·양적긴축 관련 논의 확인.', category: 'rate', region: '미국', publishedAt: new Date('2026-10-08T03:00:00') }, // prettier-ignore
  ...
  { id: 'n40', title: '삼성전자 3분기 잠정 실적', summary: '메모리 업황 반등 폭과 파운드리 적자 축소 여부가 관전 포인트.', category: 'earnings', region: '삼성전자', publishedAt: new Date('2026-10-11T08:00:00'), highlight: 'special', detail: { forecast: '영업이익 12조원', previous: '10.4조원', source: '삼성전자', sectors: ['메모리', 'HBM', '파운드리'] } }, // prettier-ignore
  ...
  { id: 'n45', title: '테슬라 3분기 실적', summary: '인도량·자동차 총마진(GPM)과 로보택시/에너지 부문 코멘트.', category: 'earnings', region: '테슬라', publishedAt: new Date('2026-10-22T06:00:00'), highlight: 'special', detail: { forecast: 'EPS 0.58달러', previous: 'EPS 0.52달러', source: 'Tesla IR', sectors: ['2차전지', '전기차 부품', '자율주행'] } }, // prettier-ignore
  { id: 'n46', title: '한국은행 10월 금융통화위원회', summary: '기준금리 결정과 수정 경제전망. 원화·건설·가계부채가 변수.', category: 'rate', region: '한국', publishedAt: new Date('2026-10-23T10:00:00'), detail: { forecast: '동결(2.50%)', previous: '2.50%', source: '한국은행', sectors: ['은행', '건설', '리츠'] } }, // prettier-ignore
  ...
  { id: 'n49', title: 'FOMC 기준금리 결정(10월)', summary: '연속 인하 여부와 12월 회의 대비 포워드 가이던스가 핵심.', category: 'rate', region: '미국', publishedAt: new Date('2026-10-29T03:00:00'), detail: { forecast: '25bp 인하', previous: '25bp 인하', source: '미국 연준(FOMC)', sectors: ['성장주', '중소형주', '리츠'] } }, // prettier-ignore
