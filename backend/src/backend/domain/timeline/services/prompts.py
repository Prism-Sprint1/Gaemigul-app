...
18. "팔아치웠다", "쓸어 담았다", "매물을 쏟아냈다" 같은 구어·과장 표현을 쓰지 마라. 하루 하락을 "약세장"(길게 이어지는 하락장)이라고 부르지 마라.
...
22. 협력·업무협약 소식을 계약·수주·대규모 매출이 확정된 것처럼 확대하지 말고, 실제 성과는 계약과 사업 진행 여부에 따라 달라진다고 구분해라.
